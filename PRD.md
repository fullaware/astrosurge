...
**Activities**:
- Select propulsion system (chemical/nuclear)
...
- `propulsion_type`: `nuclear_thermal | fusion | ion | solar_electric`
...
- `propulsion_type`: `chemical | nuclear_thermal | ion | solar_electric`
- `crew_capacity`: Number of personnel (0 for AI-only)
...
**Unlocked Capabilities** (added via upgrades between missions):
- `water_extraction`: Boolean (Tier 2 unlock)
- `propulsion_manufacturing`: Boolean (Tier 3 unlock)
- `advanced_refinement`: Boolean (Tier 4 unlock)
- `swarm_ai`: Boolean (Tier 4 unlock)
