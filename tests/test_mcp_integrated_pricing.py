"""
Test suite for MCP-integrated commodity pricing service
"""
import pytest
...
class TestMCPIntegratedPricingService:
    """Test cases for MCP-integrated commodity pricing service"""
    
    def setup_method(self):
        """Set up test fixtures"""
        self.pricing_service = MCPIntegratedPricingService()
    ...
    @patch.object(MCPIntegratedPricingService, 'fetch_all_commodity_prices')
    ...
    @patch.object(MCPIntegratedPricingService, 'get_commodity_prices_per_kg')
